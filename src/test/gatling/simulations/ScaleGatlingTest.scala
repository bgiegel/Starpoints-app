...
/**
 * Performance test for the Scale entity.
 */
class ScaleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Scale entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created scale")
                .get("${new_scale_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created scale")
            .delete("${new_scale_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
