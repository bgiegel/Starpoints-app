...
/**
 * Performance test for the Contribution entity.
 */
class ContributionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contribution entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all contributions")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created contribution")
                .get("${new_contribution_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created contribution")
            .delete("${new_contribution_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
